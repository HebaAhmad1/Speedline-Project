  ...
  <body class="about" dir="rtl">
    ...
    <div class="wrapper">
      ...
      <div class="first-section">
        <div class="container">
          <div class="row">
            <div id="sync1" class="owl-carousel owl-theme" onclick="carousel()">
              <div class="text">
                <h1>من نحن ؟</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-6 text-about">
            <h2 class="h2-main">اهلا وسهلا بكم في شركة سبيد لاين للاتصالات</h2>
            <p>
            ...
            <div class="col-xl-7 col-12">
              ...
              <ul class="list-unstyled animatedParent">
                <li
                  ...
                  "
                >
                  <img src="../wwwroot/img/icon-about.svg" alt="icon-about" />
                  <div class="content">
                    <h5>بداياتنا</h5>
                    <p>
                ...
                <li
                  ...
                  "
                >
                  <img src="../wwwroot/img/icon-about2.svg" alt="icon-about" />
                  <div class="content">
                    <h5>خدماتنا</h5>
                    <p>
                      نقدم خدمات مميزة ومتميزة للمصالح التجارية والافراد
                      والشركات كما نزود زبائننا بجميع الحلول المتكاملة في عالم
                ...
                <li
                  ...
                  "
                >
                  <img src="../wwwroot/img/icon-about4.svg" alt="icon-about" />
                  <div class="content">
                    <h5>وكلاؤنا</h5>
                    <p>
                      يوجد لديناعدد كبير من الوكلاء والموزعين المنتشرين في جميع
                      المناطق الفلسطينيه والخط الاخضر
                    </p>
                  </div>
                </li>
                <li
                  ...
                  "
                >
                  <img src="../wwwroot/img/icon-about3.svg" alt="icon-about" />
                  <div class="content">
                    <h5>الدعم الفني</h5>
                    <p>
                      مركز خدمة هاتفي يعمل من اجلكم على مدار 24 ساعه يوما لتقديم
                      المساعده والدعم
                    </p>
                  </div>
                </li>
                <li
                  ...
                  "
                >
                  <img src="../wwwroot/img/icon-about5.svg" alt="icon-about" />
                  <div class="content">
                    <h5>ما يميزنا</h5>
                    <p>جودة عالية بمعايير عالمية</p>
                  </div>
                </li>
                <li
                  class="
                  ...
                  "
                >
                  <img src="../wwwroot/img/icon-about6.svg" alt="icon-about" />
                  <div class="content">
                    <h5>فريقنا</h5>
                    <p>فريق عملنا جاهز لخدمتكم وتقديم أفضل الحلول لزبائننا</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="text-head text-center">
              <h5>فريقنا</h5>
              <h2 class="h2-main">أكثر من عائلة</h2>
              <p>فريق عمل متخصص ومميز</p>
            </div>
            <!--text-head-->
          </div>
        </div>
