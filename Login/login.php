...
if(isset($_POST['login'])) {
    $user1= htmlspecialchars($_POST['name']);
    $pass = htmlspecialchars($_POST['password']);

    $sql = "SELECT * FROM users WHERE name = '$user1' and password='$pass'";
      ...
      <div class="container animatedParent">
        <div class="row">Password
          <div class="col-xl-12 animated growIn">
            <!--===================== Custom Form ========================-->
            <form action="index.html" class="custom-form" id="account" method="post">
              <h4>تسجيل الدخول</h4>
